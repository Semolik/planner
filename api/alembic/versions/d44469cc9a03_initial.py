...
Revision ID: d44469cc9a03
Revises: 
Create Date: 2025-06-13 10:27:59.703035
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_event_groups_id'),
                    'event_groups', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_event_levels_id'),
                    'event_levels', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_personal_events_id'),
                    'personal_events', ['id'], unique=False)
    op.create_table('requirements',
                    sa.Column('id', sa.UUID(), nullable=False),
                    sa.Column('period_start', sa.DateTime(), nullable=False),
                    sa.Column('period_end', sa.DateTime(), nullable=False),
                    sa.Column('user_role', sa.Enum('PHOTOGRAPHER', 'COPYWRITER',
                                                   'DESIGNER', name='userrole'), nullable=False),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('tasks_token',
                    ...
                    sa.Column('updated_at', sa.TIMESTAMP(timezone=True),
                              server_default=sa.text('now()'), nullable=True),
                    sa.Column('role', sa.Enum('PHOTOGRAPHER', 'COPYWRITER',
                                              'DESIGNER', name='userrole'), nullable=False),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_index(op.f('ix_tasks_token_id'),
                    'tasks_token', ['id'], unique=False)
    op.create_table('events',
                    ...
                    sa.Column('organizer', sa.String(), nullable=False),
                    sa.Column('link', sa.Text(), nullable=False),
                    sa.Column('required_photographers',
                              sa.Integer(), nullable=False),
                    sa.Column('description', sa.Text(), nullable=False),
                    sa.Column('level_id', sa.UUID(), nullable=True),
                    sa.Column('group_id', sa.UUID(), nullable=True),
                    sa.ForeignKeyConstraint(
                        ['group_id'], ['event_groups.id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['level_id'], ['event_levels.id'], ondelete='SET NULL'),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('typed_tasks',
                    ...
                    sa.Column('task_type', sa.Enum('PHOTOGRAPHER', 'COPYWRITER',
                                                   'DESIGNER', name='userrole'), nullable=False),
                    sa.Column('description', sa.Text(), nullable=False),
                    ...
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('task_id', 'task_type',
                                        name='uq_typed_task_task_id_task_type')
                    )
    op.create_index(op.f('ix_typed_tasks_id'),
                    'typed_tasks', ['id'], unique=False)
    op.create_table('task_states',
                    sa.Column('id', sa.UUID(), nullable=False),
                    sa.Column('type_task_id', sa.UUID(), nullable=False),
                    sa.Column('user_id', sa.UUID(), nullable=False),
                    sa.Column('state', sa.Enum('PENDING', 'CANCELED',
                                               'COMPLETED', name='state'), nullable=False),
                    sa.Column('comment', sa.Text(), nullable=False),
                    sa.ForeignKeyConstraint(
                        ['type_task_id'], ['typed_tasks.id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['user_id'], ['users.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('type_task_id', 'user_id',
                                        name='uq_task_states_type_task_id_user_id')
                    )
    op.create_index(op.f('ix_task_states_id'),
                    'task_states', ['id'], unique=False)
    op.create_table('task_states_periods',
                    ...
                    sa.ForeignKeyConstraint(
                        ['task_state_id'], ['task_states.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('task_state_id'),
                    sa.UniqueConstraint('task_state_id', 'period_start', 'period_end',
